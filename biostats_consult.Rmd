...
plot_2022 <- ggplot(missing_2022, aes(x = reorder(variable, -missing_percentage), y = missing_percentage)) +
  ...
  coord_flip() +
  labs(title = "Percentage of Missing Values in data_2022_cleaned", x = "Variables", y = "Missing Percentage (%)") +
  theme_minimal()
...
plot_2024 <- ggplot(missing_2024, aes(x = reorder(variable, -missing_percentage), y = missing_percentage)) +
  geom_bar(stat = "identity", fill = "red") +
  coord_flip() +
  labs(title = "Percentage of Missing Values in data_2024_cleaned", x = "Variables", y = "Missing Percentage (%)") +
  theme_minimal()
